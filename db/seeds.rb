...
roger = User.create!(name: "Roger", email: "roger@gmail.com", password: "roger")
gene = User.create!(name: "Gene", email: "gene@gmail.com", password: "gene")
elvis = User.create!(name: "Elvis", email: "theking@gmail.com", password: "perscilla")


movie = Movie.find_by(title: 'Iron Man')
movie.reviews.create!(stars: 3, comment: "I laughed, I cried, I spilled my popcorn!", user_id: User.first.id)
movie.reviews.create!(stars: 5, comment: "I'm a better reviewer than he is.", user_id: User.second.id)
movie.reviews.create!(stars: 4, comment: "It's been years since a movie superhero was this fierce and this funny.", user_id: User.third.id)
